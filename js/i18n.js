...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'sheet.s.radar': 'Live radar — scrub the last hour and the projection',
      'sheet.s.fcstradar': 'NOAA HRRR model — future radar, a FORECAST not observation · via Iowa Environmental Mesonet',
      ...
      'fcst.play': 'Play / pause the forecast loop',
      'fcst.scrub': 'Scrub forecast hour: +1h → +18h (HRRR model)',
      ...
      'glossary.fcstradar': 'NOAA HRRR model reflectivity via Iowa Environmental Mesonet — a model\'s prediction of future radar (+1h to +18h), never observed echoes; the amber dashed bar and FORECAST MODEL badge mark it',
    ...
    es: {
      ...
      'sheet.s.radar': 'Radar en vivo — recorra la última hora y la proyección',
      'sheet.s.fcstradar': 'Modelo HRRR de NOAA — radar futuro, un PRONÓSTICO, no observación · vía Iowa Environmental Mesonet',
      ...
      'fcst.play': 'Reproducir / pausar el bucle del pronóstico',
      'fcst.scrub': 'Recorra la hora de pronóstico: +1h → +18h (modelo HRRR)',
      ...
      'glossary.fcstradar': 'reflectividad del modelo HRRR de NOAA vía Iowa Environmental Mesonet — la predicción de un modelo del radar futuro (+1h a +18h), nunca ecos observados; la barra ámbar discontinua y la insignia MODELO DE PRONÓSTICO lo marcan',
